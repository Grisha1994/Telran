...
//   document.body.style.backgroundColor = color[color_index++ % color.length]
// });
...
//   event.target.src = photos[index++ % photos.length]
// });
...
//     img_slider1.src = photos[++index % photos.length]
...
//   text_input.value = input[index++ % input.length]
// });
